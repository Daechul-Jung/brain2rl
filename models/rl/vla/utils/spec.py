...
class ModuleSpec(TypedDict):
    """
    A JSON-serializable representation of a function or class with some default args and kwargs to pass to it. 
    Useful for specifying a particular class or function in a config file, while keeping it serializable 
    ...
    Note: ModuleSpec is just an alias for a dictionary (that is strongly typed), not a real class. 
    So from a code's perspective, it is just a dictionary
    ...
    @staticmethod
    def create(callable_or_full_name: Union[str, callable], *args, **kwargs) -> "ModuleSpec":
        """
        ...
        Args:
            ...
            kwargs(tuple, optional): passed into callable upon instantiation 
        """
    ...
    @staticmethod
    def instantiate(spec: "ModuleSpec"):  
